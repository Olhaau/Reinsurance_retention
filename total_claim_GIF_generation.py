...
os.chdir(r'C:\Users\Asus\Documents\01_code\03_projects\00_insurance_retention')
...
def update(i):
    ...
    line.set_color('C' + str(i))
    ax.collections.clear()
    p = plt.fill_between(tc_df.value[:500], tc_df.iloc[:500,i], 0, alpha = .5, color = 'C' + str(i))
    return line, ax, p,
